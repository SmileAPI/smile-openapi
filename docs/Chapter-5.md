...
|Achive Creation Successful|ARCHIVE_STARTED|Sent when a user has uploaded one or several files which becomes an "archive" in Smile.|
...
Below is example code in NodeJS to check the validity of a payload using HMAC-SHA512:
